...
- `P1-24a-F02` — Alle: Der Horizont der Plantafel ist 1, 2, 4 oder 6 Wochen (Auswahl in der Kopfzeile); „Zurück“ und „Weiter“ springen um den Horizont, „Diese Woche“ (bei längeren Horizonten „Aktueller Zeitraum“) kehrt zum aktuellen Zeitraum zurück, und der heutige Tag ist in der Kopfzeile markiert.
...
- `P1-24a-F13` — Büro/Admin: Eine Parkplatz-Karte auf eine Zelle ziehen plant den Auftrag bei dieser Person an diesem Tag ein, in einem Serveraufruf mit Rückabwicklung bei Fehlschlag; im Tag landet sie auf einer Uhrzeit. Auf dem Desktop steht der Parkplatz neben der Plantafel und verdeckt keine Spalte; Escape schließt ihn, solange kein Dialog offen ist. Beim Ziehen aus dem Parkplatz scrollt die Plantafel erst, wenn der Zeiger kurz am Rand verharrt, nie während er vom Panel herüberkommt. Ein geparkter Auftrag ohne Parkplatz-Kontext (Altbestand) wird schon beim Ziehen mit Satz abgelehnt und bietet kein „Einplanen am …“, bis ein Kontext ergänzt ist.
...
- `P1-24a-F21` — Alle: Ansicht, Horizont, Dichte („Kompakt“ und „Komfortabel“), Wochenende, Filter, Suche und „Termine“ bleiben je Benutzer und Organisation erhalten und gelten beim nächsten Öffnen (die Suche wird 600 ms nach der letzten Eingabe gespeichert, alles andere sofort; „Arbeitszeiten“ gilt nur für die Sitzung); der Kalender öffnet in der zuletzt gewählten Ansicht, sonst Büro und Admin auf der Plantafel und Handwerker im Tag.
