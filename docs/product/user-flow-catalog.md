...
- `P1-24a-F13` — Büro/Admin: Eine Parkplatz-Karte auf eine Zelle ziehen plant den Auftrag bei dieser Person an diesem Tag ein, in einem Serveraufruf mit Rückabwicklung bei Fehlschlag; im Tag landet sie auf einer Uhrzeit.
...
- `P1-24a-F34` — Alle: Bei 1280 px Breite scrollt keine Ansicht seitlich (Plantafel bei einer Woche, Monat); Tag und längere Horizonte scrollen nur innerhalb des Kalenders; bei 2560 px wachsen Spalten und Karten; auf dem Telefon zeigt die Woche eines Handwerkers eine Tagesliste, nie ein beschnittenes Raster.
