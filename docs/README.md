...
| [uiux-hardening-2026-09.md](plans/uiux-hardening-2026-09.md) | Living — the pre-handoff UI/UX hardening ledger: owner rulings, the classification of every 2026-09-03 finding (missed, regression, gap), phase checklist, verification record. |
