...
| [security-infrastructure-hardening-2026-09.md](plans/security-infrastructure-hardening-2026-09.md) | Closed — Step 1 security audit record: boundary inventory, findings SI-001 to SI-028 with dispositions, owner decisions, verification evidence and its deliberate limits, and the handoff to the performance pass. Current rules live in [security.md](technical/security.md). |
