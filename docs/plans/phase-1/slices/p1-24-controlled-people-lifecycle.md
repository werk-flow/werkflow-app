...
| Tier 2 | The shared searchable picker waits for a visible and enabled trigger before bounded remount retries. | `tests/golden/support/steps.ts` | Final A3 5/5 and A1 28/28. |
