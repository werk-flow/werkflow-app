...
| | |
| --- | --- |
| Done | Brief + two full inventories (2026-08-21); canon confirmed; **S1** (canon), **S2** (primitives, 93/93), **M1** (Anfragen + Kunden, 93/93), **M2** (Auftraege + Aufgaben, 93/93), **M3** (Kalender + Dispatch, 93/93) |
| Next | **M4** — Mitarbeiter + Settings + Organization |
| Then | M5 → final gate |
