...
| | |
| --- | --- |
| Done | Brief + two full inventories (2026-08-21); canon confirmed; **S1** (canon), **S2** (primitives, 93/93), **M1** (Anfragen + Kunden, 93/93), **M2** (Auftraege + Aufgaben, 93/93) |
| Next | **M3** — Kalender + Dispatch |
| Then | M4 → M5 → final gate |
