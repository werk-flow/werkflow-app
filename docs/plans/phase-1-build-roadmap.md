...
> **Current checkpoint:** `P1-00` and `P1-00a` accepted `complete` 2026-08-04; `P1-01` implementation in progress with owner-approved design  
> **Formally accepted roadmap slices:** 2 of 56 (`P1-00` and `P1-00a` through `P1-54`)  
...
| Field | Current value |
| --- | --- |
| Active slice | `P1-01` (`in_progress` — this session, started 2026-08-04; owner approved the design: additive contact/site schema, project-default-site with job override, manual `Kundennummer`) |
| Next slice | `P1-02` after `P1-01` acceptance (`P1-03` may run in parallel) |
