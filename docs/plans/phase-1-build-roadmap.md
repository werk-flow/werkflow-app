...
> **Current checkpoint:** `P1-05` is `in_progress` (approved design checkpoint 2026-08-05); `P1-00` through `P1-04` are accepted `complete`
> **Formally accepted roadmap slices:** 6 of 56 (`P1-00` and `P1-00a` through `P1-54`)  
...
| Field | Current value |
| --- | --- |
| Active slice | `P1-05` — scoped responsibilities, approvers, substitutes, and date-effective delegation (`in_progress` 2026-08-05) |
| Next slice | `P1-06` becomes `ready` when `P1-05` is accepted `complete`; its other prerequisite `P1-04` is complete |
...
| `P1-05` | `in_progress` | Default roles gain clear scoped responsibilities, approvers, substitutes, and date-effective delegation without exposing a generic unsafe role builder | `P1-03` | Employee management; time; calendar; all approval consumers | Design approved 2026-08-05: fixed roles plus `time_approval`/`leave_approval`; explicit holders replace the operational role default while the owner retains recovery authority; Büro users' own new manual entries become pending, while admin-owned entries and Büro edit/delete behavior remain unchanged. Implementation and exit evidence in progress |
