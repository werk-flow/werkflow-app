...
> **Current checkpoint:** `P1-00`, `P1-00a`, and `P1-01` accepted `complete` 2026-08-04; next eligible slices are `P1-02` and `P1-03` (parallel-safe per the parallel work rules)  
> **Formally accepted roadmap slices:** 3 of 56 (`P1-00` and `P1-00a` through `P1-54`)  
...
| Field | Current value |
| --- | --- |
| Active slice | None — `P1-01` accepted `complete` 2026-08-04 |
| Next slice | `P1-02` (now `ready`); `P1-03` may run in parallel |
| Next feature slice after baseline lock | `P1-02` |
...
| `P1-02` | `ready` | Admin/Büro can capture an operational request and deliberately convert it into a job/project without re-entering customer, contact, site, summary, urgency, attachments, or commitments | `P1-00a`, `P1-01` | Customers/CRM; jobs; calendar; documents | Conversion is duplicate-safe and auditable; direct work creation still works; `GG-01` passes |
| `P1-03` | `ready` | Admin/Büro can maintain a stable employee/personnel identity with date-effective employment conditions without changing historical work/time meaning | `P1-00` | Employee management; time; documents | Existing members migrate; future/non-login/exited states and history are distinguishable |
