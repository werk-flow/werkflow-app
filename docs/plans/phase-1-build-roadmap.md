...
| Field | Current value |
| --- | --- |
| Active slice | None — `P1-05` accepted `complete` 2026-08-06 |
| Next slice | `P1-06` — vacation requests, decisions, balances, availability, calendar conflicts, target-time effects, and history (`ready`) |
