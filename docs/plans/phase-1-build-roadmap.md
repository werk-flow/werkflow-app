...
> **Current checkpoint:** `P1-09` is `in_progress` after product-owner confirmation of its team, qualification, privacy, authority, eligibility, Realtime/cache, and test contracts; `P1-10` and `P1-13` remain `ready`
...
| Field | Current value |
| --- | --- |
| Active slice | `P1-09` — teams/skills/certifications (`in_progress`; implementation owner: this Codex task on `main`, started 2026-08-08) |
| Next slice | Complete `P1-09`; prerequisites `P1-03` and `P1-05` are both `complete`; its completion also extends the `GG-02` gate spec with sickness and qualification constraints in one step |
...
| Latest completed golden gate | `GG-02` rerun with `P1-08` — full suite 69/69 (incl. `@GG-02` 7/7 unchanged and new `@P1-08` 6/6) on a fresh production build, 2026-08-08 (`docs/plans/golden-gate-log.md`); rerun again after `P1-09` |
| Known execution blocker | None — the product owner confirmed all P1-09 pre-implementation decisions on 2026-08-08 |
| Last roadmap review | 7 August 2026 |
...
| `P1-09` | `in_progress` | Authorized users can maintain teams, skills, certifications, validity, evidence, and operational eligibility; planning can explain qualification coverage | `P1-03`, `P1-05` | Employee management; calendar; jobs; documents | Expiry/history, evidence privacy, apprentice supervision, and assignment warning cases pass. Product owner confirmed the pre-implementation report's items 2–8 on 2026-08-08; implementation follows the recorded team, qualification, visibility, authority, eligibility, Realtime/cache, and test contracts |
