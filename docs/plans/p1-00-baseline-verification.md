...
2. **`GG-00` coverage gaps.** Not yet automated: invites/onboarding, time tracking, inventory take/return, Realtime freshness, mobile/responsive paths. Either extend the automated gate or record an owner-run manual pass for these areas before marking `P1-00` complete. Partial manual evidence exists: owner verified document upload/view/download on a production build 2026-08-04.
