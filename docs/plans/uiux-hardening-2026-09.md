...
- [ ] **Phase 2, layout.** Every page onto the shell; Service and Zeiterfassung layouts; time rules moved; subpage loading states; Suspense boundaries so headers paint first; FAB clearance; one title style; the 375 px viewport audit; finding 16.
