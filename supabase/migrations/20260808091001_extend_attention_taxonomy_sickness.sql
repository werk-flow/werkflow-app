...
-- P1-08: extend the P1-07 attention taxonomy with 'sickness_report'.
-- All three enforcement points move together: both source_type CHECK
-- constraints AND the org-validation trigger (which would otherwise silently
-- accept an unknown type without validating its source row).
