...
-- Update the redeem_organization_invite function to validate that the user's email matches the invite email
...
begin
  ...
  -- Get invite details including the email it was sent to
  select i.organization_id
       ...
       , i.expires_at
       , i.email
  into v_org_id, v_admin_id, v_org_name, v_invite_status, v_expires_at, v_invite_email
